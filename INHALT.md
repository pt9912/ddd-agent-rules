...
- [DDD-BC-001 – Autonomie von Bounded Contexts schützen](rules/05-bounded-contexts.md)
- [DDD-ENT-001 – Entitäten für Identität und Lebenszyklus verwenden](rules/06-entities.md)
- [DDD-VO-001 – Wertobjekte für beschreibende Konzepte bevorzugen](rules/07-value-objects.md)
- [DDD-AGG-001 – Aggregatgrenzen schützen](rules/08-aggregates.md)
- [DDD-SVC-001 – Domänendienste nur für Domänenoperationen ohne natürlichen Eigentümer verwenden](rules/09-domain-services.md)
- [DDD-REP-001 – Repositories für die Persistenz von Aggregaten verwenden](rules/10-repositories.md)
- [DDD-EVT-001 – Tatsachen als Domänenereignisse veröffentlichen](rules/11-domain-events.md)
- [DDD-APP-001 – Anwendungsdienste schlank halten](rules/12-application-layer.md)
- [DDD-INF-001 – Infrastruktur außerhalb der Domäne halten](rules/13-infrastructure-layer.md)
- [DDD-INT-001 – Über Grenzen von Bounded Contexts hinweg übersetzen](rules/14-context-integration.md)
- [DDD-TEST-001 – Fachliches Verhalten an der Domänengrenze testen](rules/15-testing.md)
- [DDD-REF-001 – Schrittweise zu klarerem Domänenverhalten refaktorieren](rules/16-refactoring.md)
